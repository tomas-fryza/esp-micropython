...
# BME280 temperature registers
BME280_REGISTER_DIG_T1 = 0x88  # Trimming parameter registers
BME280_REGISTER_DIG_T2 = 0x8A
BME280_REGISTER_DIG_T3 = 0x8C
# BME280 Pressure registers
...
class Device:
    ...
    def readRaw8(self):
        ...
        return int.from_bytes(
            self._i2c.readfrom(self._address, 1), 'little') & 0xFF
...
class BME280:
    def __init__(self, i2c=None, mode=BME280_OSAMPLE_1, addr=BME280_I2CADDR, **kwargs):
    ...
    def read_humidity(self):
        ...
        h = self.t_fine - 76800
        h = (((((adc << 14) - (self.dig_H4 << 20) - (self.dig_H5 * h)) + 16384) >> 15) * (((((((h * self.dig_H6) >> 10) * (((h *
